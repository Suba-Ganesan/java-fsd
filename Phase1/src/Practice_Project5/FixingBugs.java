...
public class FixingBugs {
	...
	private static void searchExpenses(ArrayList<Integer> arrayList) {
		...
		if (ans)
			System.out.println("The list contains " + expense + " at index:" + arrayList.indexOf(expense));
		else
			System.out.println("The list does not contains " + expense);
	...
	private static void sortExpenses(ArrayList<Integer> arrayList) {
		...
		System.out.println("sorted result=" + arrayList);
